...
void TcpConnection::setContext(const tinyWS_process1::any& context) {
    context_ = context;
}

const tinyWS_process1::any& TcpConnection::getContext() const {
    return context_;
}

tinyWS_process1::any* TcpConnection::getMutableContext() {
    return &context_;
}
