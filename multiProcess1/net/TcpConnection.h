...
namespace tinyWS_process1 {
    ...
    private:
        ...
        tinyWS_process1::any context_;                  // 接收到的请求的内容
    ...
    public:
        ...
        void setContext(const tinyWS_process1::any& context);
        const tinyWS_process1::any& getContext() const;
        tinyWS_process1::any* getMutableContext();
